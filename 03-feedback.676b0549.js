...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r="formSavedInf",o=document.querySelector(".feedback-form"),n=document.querySelector(".feedback-form input"),a=document.querySelector(".feedback-form textarea");o.addEventListener("submit",s),o.addEventListener("input",(0,e.default)(u,500));const c={};function u(e){c[e.target.name]=e.target.value,localStorage.setItem(r,JSON.stringify(c)),console.log(c)}function l(){const e=JSON.parse(localStorage.getItem(r));e&&(console.log(e),Object.entries(e).forEach(([e,t])=>{c[e]=t,o.elements[e].value=t}))}function s(e){e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem(r)}l();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08-/03-feedback.676b0549.js.map