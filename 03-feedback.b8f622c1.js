...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o="formSavedInf",r=document.querySelector(".feedback-form"),a=document.querySelector(".feedback-form input"),n=document.querySelector(".feedback-form textarea");r.addEventListener("submit",s),r.addEventListener("input",(0,e.default)(c,500));const u={};function c(e){u[e.target.name]=e.target.value,localStorage.setItem(o,JSON.stringify(u)),console.log(u)}function l(){const e=JSON.parse(localStorage.getItem(o));e&&(console.log(e),a.value=e.email,n.value=e.message)}function s(e){e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem(o)}l();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08-/03-feedback.b8f622c1.js.map