...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a="formSavedInf",r=document.querySelector(".feedback-form"),n=document.querySelector(".feedback-form input"),c=document.querySelector(".feedback-form textarea"),u={};function o(e){u[e.target.name]=e.target.value,localStorage.setItem("FORM_SAVED_INF",JSON.stringify(u))}function i(e){e.preventDefault();const t=e.currentTarget.elements,r={inputActive:t.email.value,textareaActive:t.message.value};console.log(r),e.currentTarget.reset(),localStorage.removeItem(a)}function l(){const e=localStorage.getItem(a),t=JSON.parse(e);t&&(n.value=t.inputActive,c.value=t.textareaActive,u.textareaActive=t.textareaActive,u.inputActive=t.inputActive)}r.addEventListener("submit",i),r.addEventListener("input",(0,e.default)(o,500)),l();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08-/03-feedback.cba777e3.js.map